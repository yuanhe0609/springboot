...
public class CallInterfaceController {
    ...
    public String callInterface(@RequestBody JSONObject headerAndBody, @PathVariable String interfaceCode) {
        ...
        return callInterfaceService.CallInterface(interfaceCode,header,body).toString();
    }
}
